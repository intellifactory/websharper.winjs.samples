...
declare module Tests {
    module Client {
        interface Resources {
            Tiles: __ABBREV.__List.T<any>;
            Images: __ABBREV.__List.T<any>;
            Settings: __ABBREV.__List.T<any>;
            ApplicationSettings: __ABBREV.__List.T<any>;
        }
        var Main : {
            (): void;
        };
...
declare module __ABBREV {
    ...
    export import __List = IntelliFactory.WebSharper.WinJS.WinJS.Binding.List;
    export import __List1 = IntelliFactory.WebSharper.List;
}
